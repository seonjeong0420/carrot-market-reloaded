...
const TabBar = (props: Props) => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full mx-auto max-w-screen-md grid grid-cols-5 border-neutral-600 border-t px-5 py-3 *:text-white bg-neutral-800">
